...
const Button = () => {
    return (
        <StyledWrapper>
            <div className="social-login-icons flex justify-around">
                <div className="socialcontainer">
                    ...
                    <div className="social-icon-1 ">
                        <svg viewBox="0 0 512 512" height="1.7em" xmlns="http://www.w3.org/2000/svg" className="svgIcontwit" fill="red">
