...
const About = () => {
    return (
        <>
            ...
            <div className='grid grid-cols-2 mb-20 mx-40'>
                <div className='bg-yellow-00'>
                    <img src={yashimg} alt="" className='w-96 rounded-4xl' />
                </div>
                <div className='text-white bg-green-00 text-center text-5xl font-bold font-sans'>Frontend Developer.
                    <p className='text-gray-400 text-2xl mt-5 font-normal text-justify'>My name is yash valecha. I'm a Front-end developer and UI Designer. I develop modern and high quality interfaces, focusing on performance, animations, responsiveness and SEO.</p>
                </div>
            </div>
        </>
    )
